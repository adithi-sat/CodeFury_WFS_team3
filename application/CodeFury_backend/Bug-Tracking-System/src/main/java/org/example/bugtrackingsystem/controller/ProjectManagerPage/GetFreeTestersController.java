...
@WebServlet("/api-get-free-testers")
public class GetFreeTestersController extends HttpServlet {
    ListOfFreeMembersService listOfFreeMembersService = new ListOfFreeMembersService();

    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {

        FreeMembersResponseDto freeMembersResponseDto = listOfFreeMembersService.getFreeTesters();
